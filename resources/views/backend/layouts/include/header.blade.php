    ...
    <div class="leftside-header">
        <div class="logo">
            <a href="#" class="on-click">
                <h1 style="margin-top: 7px;">BAITS</h1>
            </a>
        </div>
...
{{--                                        <label class="check" for="check-s1">Accusantium eveniet ipsam--}}
{{--                                            neque</label>--}}
{{--                                    </div>--}}
{{--                                </li>--}}
{{--                                <li>--}}
...
{{--                                        <label class="check" for="check-s3">Dolor eligendi in ipsum--}}
{{--                                            sapiente</label>--}}
{{--                                    </div>--}}
{{--                                </li>--}}
{{--                                <li>--}}
...
{{--                                        <label class="check" for="check-s5">Adipisci amet officia tempore--}}
{{--                                            ut</label>--}}
{{--                                    </div>--}}
{{--                                </li>--}}
{{--                            </ul>--}}
...
{{--                <i class="fa fa-comments-o" aria-hidden="true"><span--}}
{{--                        class="badge badge-xs badge-top-right x-danger"><i class="fa fa-exclamation"></i></span>--}}
{{--                </i>--}}
{{--                <div class="dropdown-box basic">--}}
{{--                    <div class="drop-header ">--}}
...
{{--                                <li>--}}
{{--                                    <a href="#">--}}
{{--                                        <div class="left-element"><img alt="profile photo"--}}
{{--                                                src="{{ asset('backend/') }}//images/avatar/avatar_1.jpg" />--}}
{{--                                        </div>--}}
{{--                                        <div class="text">--}}
...
{{--                                    <a href="#">--}}
{{--                                        <div class="left-element"><img alt="profile photo"--}}
{{--                                                src="{{ asset('backend/') }}/images/avatar/avatar_2.jpg" />--}}
{{--                                        </div>--}}
{{--                                        <div class="text">--}}
...
{{--                                    <a href="#">--}}
{{--                                        <div class="left-element"><img alt="profile photo"--}}
{{--                                                src="{{ asset('backend/') }}/images/avatar/avatar_3.jpg" />--}}
{{--                                        </div>--}}
{{--                                        <div class="text">--}}
...
{{--                                    <a href="#">--}}
{{--                                        <div class="left-element"><img alt="profile photo"--}}
{{--                                                src="{{ asset('backend/') }}/images/avatar/avatar_4.jpg" />--}}
{{--                                        </div>--}}
{{--                                        <div class="text">--}}
...
{{--                                    <a href="#">--}}
{{--                                        <div class="left-element"><img alt="profile photo"--}}
{{--                                                src="{{ asset('backend/') }}/images/avatar/avatar_5.jpg" />--}}
{{--                                        </div>--}}
{{--                                        <div class="text">--}}
...
{{--        </div>--}}
        ...
        <div class="header-section" id="user-headerbox">
            ...
            <div class="user-options dropdown-box">
                <div class="drop-content basic">
                    <ul>
                        <li> <a href="pages_user-profile.html"><i class="fa fa-user" aria-hidden="true"></i>
                                Profile</a></li>
        ...
        <div class="header-section">
            <a data-toggle="tooltip" data-placement="left" title="Logout" href="{{ route('logout') }}"
